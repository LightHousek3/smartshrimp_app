...
mixin _$PondFarm {
 ...
 String get id; String get name; DateTime? get archivedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PondFarm&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.archivedAt, archivedAt) || other.archivedAt == archivedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,archivedAt);

@override
String toString() {
  return 'PondFarm(id: $id, name: $name, archivedAt: $archivedAt)';
}
...
@useResult
$Res call({
 String id, String name, DateTime? archivedAt
});
...
/// Create a copy of PondFarm
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? archivedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  DateTime? archivedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PondFarm() when $default != null:
return $default(_that.id,_that.name,_that.archivedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  DateTime? archivedAt)  $default,) {final _that = this;
switch (_that) {
case _PondFarm():
return $default(_that.id,_that.name,_that.archivedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  DateTime? archivedAt)?  $default,) {final _that = this;
switch (_that) {
case _PondFarm() when $default != null:
return $default(_that.id,_that.name,_that.archivedAt);case _:
  return null;
...
class _PondFarm implements PondFarm {
  const _PondFarm({required this.id, required this.name, this.archivedAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PondFarm&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.archivedAt, archivedAt) || other.archivedAt == archivedAt));
}
...
/// Create a copy of PondFarm
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? archivedAt = freezed,}) {
...
mixin _$Pond {
 ...
 String get id; String get farmId; String get name; double? get areaM2; double? get depthM; double? get volumeM3;@JsonKey(unknownEnumValue: PondType.unknown) PondType get type;@JsonKey(unknownEnumValue: PondStatus.unknown) PondStatus get status; DateTime? get archivedAt; DateTime? get createdAt; DateTime? get updatedAt; PondFarm? get farm; PondCurrentSeason? get currentSeason;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,farmId,name,areaM2,depthM,volumeM3,type,status,archivedAt,createdAt,updatedAt,farm,currentSeason);

@override
String toString() {
  return 'Pond(id: $id, farmId: $farmId, name: $name, areaM2: $areaM2, depthM: $depthM, volumeM3: $volumeM3, type: $type, status: $status, archivedAt: $archivedAt, createdAt: $createdAt, updatedAt: $updatedAt, farm: $farm, currentSeason: $currentSeason)';
}
...
@useResult
$Res call({
 String id, String farmId, String name, double? areaM2, double? depthM, double? volumeM3,@JsonKey(unknownEnumValue: PondType.unknown) PondType type,@JsonKey(unknownEnumValue: PondStatus.unknown) PondStatus status, DateTime? archivedAt, DateTime? createdAt, DateTime? updatedAt, PondFarm? farm, PondCurrentSeason? currentSeason
});
...
/// Create a copy of Pond
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? farmId = null,Object? name = null,Object? areaM2 = freezed,Object? depthM = freezed,Object? volumeM3 = freezed,Object? type = null,Object? status = null,Object? archivedAt = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? farm = freezed,Object? currentSeason = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as PondStatus,archivedAt: freezed == archivedAt ? _self.archivedAt : archivedAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String farmId,  String name,  double? areaM2,  double? depthM,  double? volumeM3, @JsonKey(unknownEnumValue: PondType.unknown)  PondType type, @JsonKey(unknownEnumValue: PondStatus.unknown)  PondStatus status,  DateTime? archivedAt,  DateTime? createdAt,  DateTime? updatedAt,  PondFarm? farm,  PondCurrentSeason? currentSeason)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Pond() when $default != null:
return $default(_that.id,_that.farmId,_that.name,_that.areaM2,_that.depthM,_that.volumeM3,_that.type,_that.status,_that.archivedAt,_that.createdAt,_that.updatedAt,_that.farm,_that.currentSeason);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String farmId,  String name,  double? areaM2,  double? depthM,  double? volumeM3, @JsonKey(unknownEnumValue: PondType.unknown)  PondType type, @JsonKey(unknownEnumValue: PondStatus.unknown)  PondStatus status,  DateTime? archivedAt,  DateTime? createdAt,  DateTime? updatedAt,  PondFarm? farm,  PondCurrentSeason? currentSeason)  $default,) {final _that = this;
switch (_that) {
case _Pond():
return $default(_that.id,_that.farmId,_that.name,_that.areaM2,_that.depthM,_that.volumeM3,_that.type,_that.status,_that.archivedAt,_that.createdAt,_that.updatedAt,_that.farm,_that.currentSeason);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String farmId,  String name,  double? areaM2,  double? depthM,  double? volumeM3, @JsonKey(unknownEnumValue: PondType.unknown)  PondType type, @JsonKey(unknownEnumValue: PondStatus.unknown)  PondStatus status,  DateTime? archivedAt,  DateTime? createdAt,  DateTime? updatedAt,  PondFarm? farm,  PondCurrentSeason? currentSeason)?  $default,) {final _that = this;
switch (_that) {
case _Pond() when $default != null:
return $default(_that.id,_that.farmId,_that.name,_that.areaM2,_that.depthM,_that.volumeM3,_that.type,_that.status,_that.archivedAt,_that.createdAt,_that.updatedAt,_that.farm,_that.currentSeason);case _:
  return null;
...
class _Pond extends Pond {
  const _Pond({required this.id, required this.farmId, required this.name, this.areaM2, this.depthM, this.volumeM3, @JsonKey(unknownEnumValue: PondType.unknown) required this.type, @JsonKey(unknownEnumValue: PondStatus.unknown) required this.status, this.archivedAt, this.createdAt, this.updatedAt, this.farm, this.currentSeason}): super._();
...
/// Create a copy of Pond
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? farmId = null,Object? name = null,Object? areaM2 = freezed,Object? depthM = freezed,Object? volumeM3 = freezed,Object? type = null,Object? status = null,Object? archivedAt = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? farm = freezed,Object? currentSeason = freezed,}) {
  return _then(_Pond(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,farmId: null == farmId ? _self.farmId : farmId // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
